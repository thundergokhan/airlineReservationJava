...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public Employee findById(int id) {
        // TODO: Belirtilen id'ye sahip employee objesi döndürmek için gerekli olan logik buraya yazılmalıdır.
        return null;
    }

    @Override
    public void deleteById(int id) {
        // TODO: Belirtilen id'ye sahip employee objesini silmek için gerekli olan logik buraya yazılmalıdır.
    }
}
